...
function BasedCookingPrivacyPolicy() {
  return (
    <div className="container mx-auto py-8">
      <article className=" bg-github-black border border-white px-4 md:px-16 py-4 rounded-md flex flex-col gap-4">
        <strong>Privacy Policy</strong>{" "}
        <p>
          Binabh Devkota built the Based Cooking app as an Open Source app. This
          SERVICE is provided by Binabh Devkota at no cost and is intended for
          use as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at Based Cooking unless
        ...
        <p>This policy is effective as of 2023-07-17</p>{" "}
        <p>
          <strong>Contact Us</strong>
        </p>{" "}
        <p>
          If you have any questions or suggestions about my Privacy Policy, do
          not hesitate to contact me at binabhdevkota@gmail.com.
        </p>{" "}
        <p>
...
export default BasedCookingPrivacyPolicy;
