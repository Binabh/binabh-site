    ...
    <div className="container mx-auto py-8">
      <article className=" bg-github-black border border-white px-4 md:px-16 py-4 rounded-md flex flex-col gap-4">
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at Hangman Pro unless
        ...
        <p>This policy is effective as of 2023-07-18</p>{" "}
        <p>
...
export default HangmanPrivacyPolicy;
