  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to DVM App, the software program
        ...
        <li>
          <p>
            ...
            this Agreement) refers to DVM App.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>By email: binabhdevkota@gmail.com</li>
      </ul>
    </div>
  );
}

export default DVMApp;
